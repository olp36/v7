...
PCBの裏面（クマのシルクが書いてある面です。）に、ダイオードを36個はんだ付けします。

ダイオードの向きに注意してください。***手前側中央の４つは、ダイオードの向きが他と異なります。***
![](./docs/assets/500x300.png)

シルクの線と、ダイオードに印字された線が同じ向きになるように、320°ほどの温度ではんだ付けしていきます。<br>
片側に予備ハンダをし、ピンセットを使ってダイオードを置き、予備ハンダを溶かして固定したら、もう片側をはんだ付けする要領で作業します。<br>
